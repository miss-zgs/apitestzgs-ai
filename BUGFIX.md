...
---
## BUG-012：断言失败测试-YAML - 状态码不匹配: 期望 666, 实际 200
响应内容: {
  "userId": 1,
  "id": 1,
  "title": "sunt aut fa

- **发现时间**：2026-06-01 14:56:19
- **严重程度**：🔴 高
- **状态**：❌ 待修复
...
---
## BUG-013：断言失败演示 - 状态码不匹配: 期望 666, 实际 200
响应内容: {
  "userId": 1,
  "id": 1,
  "title": "sunt aut fa

- **发现时间**：2026-06-01 14:56:31
- **严重程度**：🔴 高
- **状态**：❌ 待修复
...
```json
{
  ...
  "post_user_id": 1,
  "post_title": "sunt aut facere repellat provident occaecati excepturi optio reprehenderit",
  "quotation_code": "2247552092###eJxIzDsOAjEMRdHFpM7Iv3GcnoZVRI6TSBRQUbALtkyY9ly9B18CQEgUXWrYyrK6ZvHw7Oozg2phI49dE2p3ndvdSvRRyJZT2Bi1FlzM6fGez/trzE/DhHwetKd81sZyCBmaSPvzCciAF+93AbZ0ExBkFfgBOh0lVw=="
}
```
